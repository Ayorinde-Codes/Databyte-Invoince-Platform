...
export const ERPConfigPage = () => {
  ...
  const availableERPs = [
    { id: 'sage_300', name: 'Sage 300', description: 'Comprehensive business management solution' },
    { id: 'sage_50', name: 'Sage 50', description: 'Small to medium business accounting' },
    { id: 'quickbooks', name: 'QuickBooks', description: 'Popular accounting software' },
    { id: 'dynamics_365', name: 'Microsoft Dynamics 365', description: 'Enterprise resource planning' },
    { id: 'sap', name: 'SAP Business One', description: 'Enterprise business management' },
    { id: 'oracle', name: 'Oracle NetSuite', description: 'Cloud-based ERP solution' },
    { id: 'xero', name: 'Xero', description: 'Cloud accounting software' },
    { id: 'zoho', name: 'Zoho Books', description: 'Online accounting software' }
  ];
  ...
  return (
    <DashboardLayout>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">ERP Configuration</h1>
                      ...
                      {availableERPs.map((erp) => (
                        <SelectItem key={erp.id} value={erp.id}>
                          <div>
                            ...
                            <div className="text-sm text-muted-foreground">{erp.description}</div>
                          </div>
                        </SelectItem>
                      ))}
                    </SelectContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Total ERPs</CardTitle>
                <Database className="h-4 w-4 text-muted-foreground" />
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">{erpConfigurations.length}</div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold text-green-600">
                  {erpConfigurations.filter(erp => erp.status === 'connected').length}
                </div>
                <p className="text-xs text-muted-foreground">
                  Working properly
                </p>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {erpConfigurations.reduce((sum, erp) => sum + erp.recordsCount, 0).toLocaleString()}
                </div>
                <p className="text-xs text-muted-foreground">
                  Synced records
                </p>
                  ...
                  <TableBody>
                    {erpConfigurations.map((erp) => (
                      <TableRow key={erp.id}>
                        ...
                        <TableCell>
                          <div className="font-medium">{erp.recordsCount.toLocaleString()}</div>
                        </TableCell>
                        <TableCell>
                          <div className="text-sm">{formatDate(erp.lastSync)}</div>
                        </TableCell>
                        <TableCell>
                ...
                <div className="border rounded-lg p-4">
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <Label className="text-sm font-medium">Platform Field</Label>
                        <div className="mt-1 p-2 bg-muted rounded text-sm">Invoice Number</div>
                      </div>
                      <div>
                        <Label className="text-sm font-medium">ERP Field</Label>
                        <Select>
                          <SelectTrigger>
                            <SelectValue placeholder="Select ERP field" />
                          </SelectTrigger>
                          <SelectContent>
                            <SelectItem value="invoice_no">INVOICE_NO</SelectItem>
                            <SelectItem value="doc_number">DOC_NUMBER</SelectItem>
                            <SelectItem value="ref_number">REF_NUMBER</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <Label className="text-sm font-medium">Platform Field</Label>
                        <div className="mt-1 p-2 bg-muted rounded text-sm">Customer Name</div>
                      </div>
                      <div>
                        <Label className="text-sm font-medium">ERP Field</Label>
                        <Select>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <Label className="text-sm font-medium">Platform Field</Label>
                        <div className="mt-1 p-2 bg-muted rounded text-sm">Invoice Amount</div>
                      </div>
                      <div>
                        <Label className="text-sm font-medium">ERP Field</Label>
                        <Select>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="invoice_total">INVOICE_TOTAL</SelectItem>
                            <SelectItem value="amount_due">AMOUNT_DUE</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
                    </div>
