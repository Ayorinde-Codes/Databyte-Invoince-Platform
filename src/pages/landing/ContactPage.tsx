              ...
              <div className="space-y-8">
                <div className="space-y-6">
                  ...
                  <p className="text-lg text-gray-600">
                    Whether you're looking to integrate your ERP system, need
                    technical support, or want to learn more about our
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="border-0 shadow-lg text-center hover:shadow-xl transition-shadow">
                ...
                <CardContent className="space-y-4">
                  <p className="text-gray-600 text-sm">
                    Get immediate assistance from our support team through our
                    live chat feature.
                  </p>
                  <div className="space-y-2">
              ...
              <Card className="border-0 shadow-lg text-center hover:shadow-xl transition-shadow">
                ...
                <CardContent className="space-y-4">
                  <p className="text-gray-600 text-sm">
                    Book a personalized demo to see how our platform can benefit
                    your business.
                  </p>
                  <div className="space-y-2">
                    <div className="flex items-center justify-center space-x-2">
              ...
              <Card className="border-0 shadow-lg text-center hover:shadow-xl transition-shadow">
                ...
                <CardContent className="space-y-4">
                  <p className="text-gray-600 text-sm">
                    Get dedicated technical support from our team of integration
                    experts.
                  </p>
                  <div className="space-y-2">
                    <div className="flex items-center justify-center space-x-2">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <Card className="border-0 shadow-sm">
                ...
                <CardContent>
                  <p className="text-gray-600">
                    Most ERP integrations can be completed within 2-4 weeks,
                    depending on the complexity of your existing system and
              ...
              <Card className="border-0 shadow-sm">
                ...
                <CardContent>
                  <p className="text-gray-600">
                    Yes, we provide comprehensive training for your team,
                    including user manuals, video tutorials, and live training
                    sessions to ensure smooth adoption.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="border-0 shadow-sm">
                ...
                <CardContent>
                  <p className="text-gray-600">
                    ...
                    ongoing consultation to ensure your e-invoicing system
