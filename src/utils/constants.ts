...
export const API_ENDPOINTS = {
  ...
  invoices: {
    ar: {
      ...
      updateItemIsicCode: '/invoices/ar/:invoiceId/items/:itemId/isic-code',
      updateItemLineType: '/invoices/ar/:invoiceId/items/:itemId/line-type',
      updateItemUom: '/invoices/ar/:invoiceId/items/:itemId/uom',
    ...
    ap: {
      ...
      updateItemIsicCode: '/invoices/ap/:invoiceId/items/:itemId/isic-code',
      updateItemLineType: '/invoices/ap/:invoiceId/items/:itemId/line-type',
      updateItemUom: '/invoices/ap/:invoiceId/items/:itemId/uom',
  ...
  firs: {
    ...
    serviceCodes: '/firs/service-codes',
    quantityCodes: '/firs/quantity-codes',
  ...
  auth: {
    ...
    tfaStatus: '/auth/tfa/status',
    tfaSetup: '/auth/tfa/setup',
    tfaEnable: '/auth/tfa/enable',
    tfaDisableSendCode: '/auth/tfa/disable/send-code',
    tfaDisable: '/auth/tfa/disable',
    tfaSwitchSetup: '/auth/tfa/switch/setup',
    tfaSwitch: '/auth/tfa/switch',
    tfaVerifyLogin: '/auth/tfa/verify-login',
    tfaResendLoginCode: '/auth/tfa/resend-login-code',
  },
  notifications: {
    list: '/notifications',
